...
// Context thresholds (percentage of context window remaining)
const CONTEXT_WARNING_PCT = 35;
const CONTEXT_CRITICAL_PCT = 25;

// Cost thresholds (USD) — calibrated for Claude 4.x pricing (2026-06-02)
// Opus 4.7: $15/$75 per 1M tokens | Sonnet 4.6: $3/$15 | Haiku 4.5: $0.80/$4
// Notice = first checkpoint, Warning = review needed, Critical = stop and inform
const COST_NOTICE_USD = 2;
const COST_WARNING_USD = 5;
const COST_CRITICAL_USD = 15;

// File scope and loop detection thresholds
